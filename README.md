...
📝 How It Works
    ...
    Scan: The script scans the current directory for *.png files.
    Check: For each file, it checks if filename.jpg already exists in the Sharing/ folder.
        If yes: Skips and logs "Skipped".
        If no: Proceeds to conversion.
    Convert:
        Linux: Uses mogrify -format jpg -quality 85 -path Sharing.
        Windows: Uses [System.Drawing.Image] to load, encode, and save with quality settings.
    Report: Displays a summary table of the operation.

🔧 Customization

You can modify the following variables at the top of the scripts to suit your needs:
Variable	Description	Default
$Quality / QUALITY	JPEG quality (0-100). Lower = smaller file.	85
$TargetSubdir	Name of the output folder.	"Sharing"
$Extension	Input file extension to look for.	"png"
📄 License

This project is provided "as-is" for educational and utility purposes. See the Disclaimer section above regarding AI-generated code.
🤝 Contributing

If you find bugs or have improvements, please feel free to submit a Pull Request. Remember to review any changes carefully before merging.

Generated with AI assistance. Please verify code before production use.🖼️ Screenshot to JPG Converter
